...
import (
	...
	"github.com/hatajoe/migrate/driver"
	"github.com/hatajoe/migrate/file"
	"github.com/hatajoe/migrate/migrate/direction"
	pipep "github.com/hatajoe/migrate/pipe"
)
...
func Create(url, migrationsPath, name string) (*file.MigrationFile, error) {
	...
	length := 4 // TODO(hatajoe) check existing files and try to guess length
